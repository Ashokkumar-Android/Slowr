package com.slowr.materialchips;
...
import com.slowr.materialchips.adapter.ChipsAdapter;
import com.slowr.materialchips.model.Chip;
import com.slowr.materialchips.model.ChipInterface;
import com.slowr.materialchips.util.ActivityUtil;
import com.slowr.materialchips.util.MyWindowCallback;
import com.slowr.materialchips.util.ViewUtil;
import com.slowr.materialchips.views.ChipsInputEditText;
import com.slowr.materialchips.views.DetailedChipView;
import com.slowr.materialchips.views.FilterableListView;
import com.slowr.materialchips.views.ScrollViewMaxHeight;
...
//                setMaxHeight(ViewUtil.dpToPx((40 * mMaxRows) + 8));
        ...
        mChipsAdapter.setCallBack(new ChipsAdapter.CallBack() {
            @Override
            public void onKeyboardDone() {
                for (ChipsListener chipsListener : mChipsListenerList) {
                    chipsListener.onKeyboardDone();
                }
            }
        });
        // set window callback
    ...
    public void addChip(String id, String label, String info) {
        ChipInterface chip = new Chip(id, label, info);
        mChipsAdapter.addChip(chip);
    }
