...
public class ServiceCategoryListAdapter extends RecyclerView.Adapter<ServiceCategoryListAdapter.MyViewHolder> {
    ...
    public ServiceCategoryListAdapter(List<CategoryItemModel> _categoryList, Context ctx) {
