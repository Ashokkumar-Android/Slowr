...
public class AttributeSelectAdapter extends RecyclerView.Adapter<AttributeSelectAdapter.MyViewHolder> implements Filterable {

    private List<AttributeSelectModel> categoryList;
    private List<AttributeSelectModel> categoryListFilter;
    Callback callback;
    Context ctx;
    String checkedPos = "";
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.layout_root:
                    ...
                    checkedPos = categoryListFilter.get(getAdapterPosition()).getId();
                    break;
                case R.id.rb_select:
                    rb_select.setChecked(true);
                    callback.itemClick(categoryListFilter.get(getAdapterPosition()));
    ...
    public AttributeSelectAdapter(List<AttributeSelectModel> _categoryList, Context ctx) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<AttributeSelectModel> filteredList = new ArrayList<>();
                    for (AttributeSelectModel row : categoryList) {

                        // name match condition. this might differ depending on your requirement
                        // here we are looking for name or phone number match
                        if (row.getAttributeValue().toLowerCase().contains(charString.toLowerCase())) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                categoryListFilter = (ArrayList<AttributeSelectModel>) filterResults.values;
