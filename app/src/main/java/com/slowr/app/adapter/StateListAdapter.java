...
public class StateListAdapter extends RecyclerView.Adapter<StateListAdapter.MyViewHolder> implements Filterable {
    ...
    private List<StateItemModel> categoryList;
    private List<StateItemModel> categoryListFilter;
    Callback callback;
    Context ctx;
    String checkedPos = "";
    ...
    public StateListAdapter(List<StateItemModel> _categoryList, Context ctx) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        try{
            StateItemModel movie = categoryListFilter.get(position);
    ...
    public interface Callback {
        void itemClick(StateItemModel model);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<StateItemModel> filteredList = new ArrayList<>();
                    for (StateItemModel row : categoryList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                categoryListFilter = (ArrayList<StateItemModel>) filterResults.values;
