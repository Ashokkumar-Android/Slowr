...
public class SearchSuggistionAdapter extends RecyclerView.Adapter<SearchSuggistionAdapter.MyViewHolder> {

    //    private List<CityItemModel> categoryList;
    private List<SuggistionItem> categoryListFilter;
    Callback callback;
    Context ctx;
    String checkedPos = "";
    ...
    public SearchSuggistionAdapter(List<SuggistionItem> _categoryList, Context ctx) {
