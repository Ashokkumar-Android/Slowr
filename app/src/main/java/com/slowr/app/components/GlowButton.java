package com.slowr.app.components;
...
public class GlowButton extends AppCompatButton implements View.OnTouchListener {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.GlowButton_buttonColor) {
                mBackgroundColor = typedArray.getColor(attr, R.color.txt_orange);
            } else if (attr == R.styleable.GlowButton_glowColor) {
                mGlowColor = typedArray.getColor(attr, R.color.txt_orange);
            } else if (attr == R.styleable.GlowButton_glowcornerRadius) {
    ...
    private void initDefaultValues() {
        ...
        mBackgroundColor = resources.getColor(R.color.txt_orange);
        mGlowColor = resources.getColor(R.color.txt_orange);
