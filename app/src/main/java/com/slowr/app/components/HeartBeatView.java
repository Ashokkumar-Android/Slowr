 ...
 */
public class HeartBeatView extends AppCompatButton {
    ...
    private void init() {
        ...
        heartDrawable = ContextCompat.getDrawable(getContext(), R.drawable.bg_orenge);
        setBackgroundDrawable(heartDrawable);
    ...
    private static final int milliInMinute = 50000;
