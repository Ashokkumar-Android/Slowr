package com.slowr.matisse.internal.ui.widget;
...
public class CropImageView extends AppCompatImageView {
    ...
    private int mMaskColor = 0xFF000000;   //暗色
    private int mBorderColor = 0xFFFFFFFF; //焦点框的边框颜色
    private int mBorderWidth = 1;         //焦点边框的宽度（画笔宽度）
    public int mFocusWidth = 250;         //焦点框的宽度
    public int mFocusHeight = 250;        //焦点框的高度
    ...
    private void initImage() {
        ...
        ((MatisseCropActivity) getContext()).getWindowManager()
                .getDefaultDisplay()
                .getMetrics(displayMetrics);
        mFocusWidth = displayMetrics.widthPixels;*/
