...
package com.gioco.image.cropper;
...
public class CropImageActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.crop_image_menu_done) {

//            setResult(Uri.fromFile(new File(mCropImageUri.getPath())), null, 1);
          setResult(RESULT_OK, getResultIntent(mCropImageUri, null, 1,1));
          finish();
            return true;
        }
    ...
    protected void setResult(Uri uri, Exception error, int sampleSize) {
        ...
        setResult(resultCode, getResultIntent(uri, error, sampleSize,2));
        finish();
    }
     ...
     */
    protected Intent getResultIntent(Uri uri, Exception error, int sampleSize,int type) {
        CropImage.ActivityResult result =
                new CropImage.ActivityResult(type,
